...
const API_PREFIX = 'https://book.youbaobao.xyz:18081'

export function getHomeData(openId) {
  return get(`${API_PREFIX}/book/home/v2`, {
    openId
  })
}
...
export function getDetailData(openId, fileName) {
  return get(`${API_PREFIX}/book/detail`, {
    fileName,
    openId
  })
}
...
export function getDetailContents(fileName) {
  return get(`${API_PREFIX}/book/contents`, {
    fileName
  })
}
...
export function saveShelf(shelf) {
  return get(`${API_PREFIX}/book/shelf/save`, {
    shelf: encodeURIComponent(JSON.stringify(shelf))
  })
}

export function removeShelf(shelf) {
  return get(`${API_PREFIX}/book/shelf/remove`, {
    shelf: encodeURIComponent(JSON.stringify(shelf))
  })
}
...
export function register(openId, user) {
  return post(`${API_PREFIX}/user/register`, {
    openId,
    ...user,
...
export function rank({
  ...
  return get(`${API_PREFIX}/book/rank/save`, {
    openId,
    fileName,
    rank
  })
...
export function day(openId) {
  return get(`${API_PREFIX}/user/day`, {
    openId
  })
}

export function hasSignToday(openId) {
  return get(`${API_PREFIX}/user/hasSignToday`, {
    openId
  })
}

export function sign(openId) {
  return get(`${API_PREFIX}/user/sign`, {
    openId
  })
}
...
export function getExerciseSet(cid = CID) {
  return get(`${API_PREFIX}/exercise/set/get`, {
    cid
  })
}

export function getExerciseChapter(exSetId, cid = CID) {
  return get(`${API_PREFIX}/exercise/chapter/get`, {
    cid,
    exSetId
  })
}
...
export function getExercise(exSetId, chapterId, cid = CID) {
  return get(`${API_PREFIX}/exercise/get`, {
    cid,
    exSetId,
    chapterId
  })
